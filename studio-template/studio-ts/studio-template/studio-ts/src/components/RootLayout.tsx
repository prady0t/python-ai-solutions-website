...
function NavigationItem({
  ...
  return (
    <Link
      href={href}
      className="group relative isolate bg-neutral-950 px-8 py-6 hover:bg-neutral-900 transition-colors"
    >
      {children}
    </Link>
  )
...
function Navigation() {
  return (
    <nav className="font-display text-xl font-medium tracking-tight text-white">
      <NavigationRow>
